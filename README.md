...
Il est possible de visualiser la liste des articles, les détails d'un article, et de créer un article directement via l'api.
...
Il est également possible d'effectuer ces tâches dans un navigateur web via une interface simple en accédant aux url suivantes :
